...
export const WithSize: Story = {
  render: () => (
    <Flex direction="col" gap="4">
      <NumberField {...defaultProps} placeholder="123.45" size="xs" />
      <NumberField {...defaultProps} placeholder="123.45" size="sm" />
      <NumberField {...defaultProps} placeholder="123.45" size="md" />
      <NumberField {...defaultProps} placeholder="123.45" size="lg" />
      <NumberField {...defaultProps} placeholder="123.45" size="xl" />
    </Flex>
  ),
};
