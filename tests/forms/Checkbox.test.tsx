...
describe("Checkbox", () => {
  ...
  test("renders a Checkbox", async () => {
    ...
    expect(label.className).toBe(
      "flex items-center gap-2 select-none group-data-[disabled=true]:pointer-events-none group-data-[disabled=true]:opacity-50 peer-disabled:cursor-not-allowed peer-disabled:opacity-50 font-display font-normal text-base text-foreground cursor-pointer",
    );
