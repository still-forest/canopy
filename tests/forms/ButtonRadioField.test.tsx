...
describe("ButtonRadioField", () => {
  ...
  describe("Rendering", () => {
    it("renders all primary options as buttons", () => {
      ...
      render(<ButtonRadioField onChange={onChange} options={OPTIONS} value={undefined} />);
    ...
    it("renders with a label", () => {
      const onChange = vi.fn();
      render(<ButtonRadioField label="Choose a character" onChange={onChange} options={OPTIONS} value={undefined} />);
    ...
    it("renders with a note", () => {
      const onChange = vi.fn();
      render(
        <ButtonRadioField note="This is a helpful note" onChange={onChange} options={OPTIONS} value={undefined} />,
      );
  ...
  describe("Accessibility - ARIA attributes", () => {
    ...
    it("uses aria-label when no label is provided", () => {
      const onChange = vi.fn();
      render(<ButtonRadioField name="character-select" onChange={onChange} options={OPTIONS} value={undefined} />);
    ...
    it("marks selected button with aria-checked=true", () => {
      const onChange = vi.fn();
      render(<ButtonRadioField onChange={onChange} options={OPTIONS} value="bart" />);
    ...
    it("updates aria-checked when selection changes", () => {
      const onChange = vi.fn();
      const { rerender } = render(<ButtonRadioField onChange={onChange} options={OPTIONS} value="bart" />);

      let buttons = screen.getAllByRole("radio");
      expect(buttons[0]).toHaveAttribute("aria-checked", "true");

      rerender(<ButtonRadioField onChange={onChange} options={OPTIONS} value="lisa" />);
  ...
  describe("Accessibility - Keyboard navigation", () => {
    it("makes only selected button tabbable", () => {
      const onChange = vi.fn();
      render(<ButtonRadioField onChange={onChange} options={OPTIONS} value="lisa" />);
    ...
    it("wraps to first option when navigating right from last option", () => {
      const onChange = vi.fn();
      render(<ButtonRadioField onChange={onChange} options={OPTIONS} value="maggie" />);
  ...
  describe("Keyboard navigation with secondary options", () => {
    it("navigates between primary and secondary options", () => {
      const onChange = vi.fn();
      render(
        <ButtonRadioField onChange={onChange} options={OPTIONS} secondaryOptions={SECONDARY_OPTIONS} value="maggie" />,
      );
    ...
    it("wraps from last secondary to first primary option", () => {
      const onChange = vi.fn();
      render(
        <ButtonRadioField onChange={onChange} options={OPTIONS} secondaryOptions={SECONDARY_OPTIONS} value="marge" />,
      );
  ...
  describe("Icon support", () => {
    it("renders buttons with icons only", () => {
      ...
      render(<ButtonRadioField onChange={onChange} options={iconOptions} value={undefined} />);
    ...
    it("works with keyboard navigation when using icons", () => {
      ...
      render(<ButtonRadioField onChange={onChange} options={iconOptions} value="home" />);
