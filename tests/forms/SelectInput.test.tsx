...
describe("SelectInput", () => {
  ...
  const EXPECTED_BASE_TRIGGER_CLASSES =
    "border-input placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground dark:hover:bg-input/50 w-full min-w-0 appearance-none rounded-md border px-3 py-2 pr-9 shadow-xs transition-[color,box-shadow] outline-none disabled:pointer-events-none disabled:cursor-not-allowed focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive h-9 text-sm bg-input/30 dark:bg-input/30";
