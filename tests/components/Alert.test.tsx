...
describe("Alert", () => {
  test("renders info Alert", async () => {
    render(<Alert type="info" message="This is a important message." />);
    ...
    expect(within(alert).getByText("This is a important message.")).toBeInTheDocument();
  });

  test("renders success Alert", async () => {
    render(<Alert type="success" message="This is a important message." />);
  ...
  test("renders warning Alert", async () => {
    render(<Alert type="warning" message="This is a important message." />);
  ...
  test("renders error Alert", async () => {
    render(<Alert type="error" message="This is a important message." />);
